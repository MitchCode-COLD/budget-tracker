    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
          ...
          {monthlyTrends.some((t) => t.income > 0 || t.expenses > 0 || t.projectedExpenses > 0 || t.projectedIncome > 0) ? (
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={monthlyTrends}>
                  ...
                  <Tooltip formatter={(value: number) => formatCurrency(value)} />
                  <Legend />
                  <Bar dataKey="projectedIncome" name="Expected Income" fill="#22c55e" fillOpacity={0.25} radius={[4, 4, 0, 0]} />
                  <Bar dataKey="income" name="Income" fill="#22c55e" radius={[4, 4, 0, 0]} />
                  <Bar dataKey="projectedExpenses" name="Expected Expenses" fill="#ef4444" fillOpacity={0.25} radius={[4, 4, 0, 0]} />
